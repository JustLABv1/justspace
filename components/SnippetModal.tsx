                        ...
                        <Modal.Header className="px-8 pt-6 pb-3 border-b border-border/20 flex flex-col items-start gap-2 shrink-0">
                            ...
                            <div className="space-y-0">
                                <Modal.Heading className="text-2xl font-bold tracking-tight text-foreground leading-none">
                                    {snippet?.id ? 'Sync Snippet' : 'Init Snippet'}
                                </Modal.Heading>
                                <p className="text-muted-foreground text-[10px] font-bold uppercase opacity-40 ml-0.5 mt-1 tracking-wider">Code Inventory</p>
                            </div>
                        </Modal.Header>
                        ...
                        <Form onSubmit={handleSubmit} className="flex flex-col min-h-0 overflow-hidden flex-1">
                            <Modal.Body className="px-8 pt-4 pb-8 space-y-4 overflow-y-auto">
                                <TextField autoFocus isRequired value={title} onChange={setTitle} className="w-full">
                                    <Label className="text-xs font-bold tracking-wider text-muted-foreground ml-1 opacity-60 uppercase">Title</Label>
                                    <Input 
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <TextField isRequired value={language} onChange={setLanguage} className="w-full">
                                        <Label className="text-xs font-bold tracking-wider text-muted-foreground ml-1 opacity-60 uppercase">Language</Label>
                                        <Input 
                                    ...
                                    <TextField value={tags} onChange={setTags} className="w-full">
                                        <Label className="text-xs font-bold tracking-wider text-muted-foreground ml-1 opacity-60 uppercase">Tags (comma separated)</Label>
                                        <Input 
                                ...
                                <TextField value={description} onChange={setDescription} className="w-full">
                                    <Label className="text-xs font-bold tracking-wider text-muted-foreground ml-1 opacity-60 uppercase">Description</Label>
                                    <TextArea 
                                ...
                                <div className="flex items-center justify-between p-4 rounded-2xl bg-surface-secondary/50 border border-border/10">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="space-y-0.5">
                                            <p className="text-xs font-bold uppercase tracking-wider text-foreground">End-to-End Encryption</p>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center justify-between">
                                        <Label className="text-xs font-bold tracking-wider text-muted-foreground ml-1 opacity-60 uppercase">Components / Blocks</Label>
                                        <div className="flex gap-2">
                                            <Button variant="secondary" size="sm" className="h-7 rounded-lg text-[10px] font-bold uppercase tracking-wider" onPress={() => addBlock('code')}>
                                                <Code size={12} className="mr-1" />
                                                Add Code
                                            </Button>
                                            <Button variant="secondary" size="sm" className="h-7 rounded-lg text-[10px] font-bold uppercase tracking-wider" onPress={() => addBlock('markdown')}>
                                        ...
                                        <div key={block.id} className="relative group p-4 rounded-2xl bg-surface-secondary/30 border border-border/20 space-y-3">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-2">
                                                    <div className="w-6 h-6 rounded-lg bg-foreground/5 flex items-center justify-center text-[10px] font-bold">
                                                        {index + 1}
                                                    </div>
