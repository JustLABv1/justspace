            ...
            >
                <Modal.Container size="sm" scroll="inside">
                    <Modal.Dialog className="rounded-xl border border-border bg-surface shadow-lg p-0 overflow-hidden flex flex-col">
                        ...
                        <Modal.Header className="px-6 pt-5 pb-3 border-b border-border shrink-0">
                            <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded-md bg-danger/10 flex items-center justify-center text-danger shrink-0">
                                    <Trash2 size={15} />
                                </div>
                                <div>
